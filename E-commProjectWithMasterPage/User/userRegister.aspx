<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="userRegister.aspx.cs" Inherits="E_commProjectWithMasterPage.User.userRegister" %>
	...
	<section class=" container min-vh-100 d-flex justify-content-center align-items-center">
			...
			<div class="container col-md-4 w-50 text-white mt-5 bg-secondary p-4 rounded">
				...
				<div class="mb-2">
					...
					<asp:DropDownList ID="DropDownList1" CssClass="mb-2 form-control" runat="server">
